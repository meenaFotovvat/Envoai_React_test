  ...
  return (
    <div className="system-monitor-container">
      ...
      <div className="stats-grid">
        <div className={`stat-card ${getRamStatus()}`}>
          ...
          <div className="stat-details">
            ...
            <div className="stat-value">
              {((systemStats.ramUsed * systemStats.ramTotal) / 100).toFixed(2)} GB /{' '}
              {systemStats.ramTotal} GB
            </div>
            <div className="stat-percentage">{systemStats.ramUsed}%</div>
        ...
        <div className={`stat-card ${getNetworkStatus()}`}>
          ...
          <div className="stat-details">
            ...
            <div className="stat-percentage">
              {parseFloat(systemStats?.networkSpeedRx) > 50
                ? 'Fast'
                : parseFloat(systemStats?.networkSpeedRx) > 10
                  ? 'Moderate'
                  : 'Slow'}
            </div>
            <div className="progress-bar">
      ...
      <div className="monitor-info">
        <p>
          <strong>Note:</strong> This is a real-time system monitor. Implemented by nodeJs.
